...
public class CsDto {
	...
	public CsDto(int board_no, int board_group, int boardgroup_no, String board_id, String board_title,
			String board_content, String board_category, Date board_date) {
