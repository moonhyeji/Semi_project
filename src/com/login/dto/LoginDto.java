...
public class LoginDto {
	...
	public LoginDto(int member_no, String member_id, String member_pw, String member_name, String member_birth,
			String member_addr, String member_phone, String member_email, String member_gender, int member_select,
			String member_question, int member_del, Date member_regdate) {
		super();
