...
public class learnDto {
	...
	public learnDto() {}
	public learnDto(int class_no, String class_title, String class_writer, String class_content, int class_price,
			int class_count, Date class_startdate, Date class_lastdate, String class_tag, int class_eventcheck,
			int class_eventprice, Date class_eventstartdate, Date class_eventlastdate) {
