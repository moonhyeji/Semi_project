	...
	<table style="margin:30px auto 30px auto;" class="read">
		...
		<tr>
			<td colspan="3" align="right">
				<input name="update" class="btn btn-outline-dark" type="button" value="수정" onclick="select_insert();"/>
				<input name="delete" class="btn btn-dark" type="submit" value="삭제" onclick="location.href='noti_delete.jsp?board_no=<%=dto.getBoard_no() %>&id=<%=id%>'"/>
				<input type="button" class="btn btn-outline-dark" value="목록" onclick="location.href='noti_list.jsp?id=<%=id%>'"/>
			</td>
		</tr>
	</table>
